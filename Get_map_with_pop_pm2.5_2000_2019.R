...
for (year in 2000:2019) {
  ...
  # Store the clipped raster for this year in the list
  clipped.raster.dpol.list[[as.character(year)]] <- clipped.raster.dpol
}
...
save(map, clipped.raster.dpol.list, file = here("map_pop_pm2.5_2000_2019.RData"))
